...
const ForemanLoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col justify-center items-center py-12 px-4 transition-colors duration-200">
...
export default ForemanLoginPage;